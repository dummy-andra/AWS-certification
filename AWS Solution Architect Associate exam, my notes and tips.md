...
— Published by *[Luciano Mammino](https://loige.co/about)*
...
- S3 can be used to host (static) websites (URL schemas: `.s3-website-.amazonaws.com` and `.s3-website..amazonaws.com`). You can use Cloudfront as a CDN to make the website fast globally.
